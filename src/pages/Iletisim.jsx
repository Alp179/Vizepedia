  ...
  return (
    <FullPage>
      ...
      <Main>
        ...
        <SubText>
          Sorularınız, önerileriniz veya yardıma ihtiyacınız mı var? Bizimle iletişime 
          geçmek için aşağıdaki bilgileri kullanabilirsiniz. Size en kısa sürede 
        ...
        >
          <ForContactContainer>
            ...
            <ForContactInfo style={{ marginTop: '16px', fontSize: '14px' }}>
              <strong>Not:</strong> Vize başvuru sonuçları veya reddedilme sebepleri 
              hakkında bilgi veremeyiz. Bu konular için ilgili konsoloslukla 
