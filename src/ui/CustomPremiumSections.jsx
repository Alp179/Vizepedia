...
const Title = styled.h1`
  ...
  background: linear-gradient(
    ...
    ${props => props.isDarkMode 
      ? `${props.gradientStart || '#fff'} 20%, ${props.gradientMid || '#e0e0e0'} 50%, ${props.gradientEnd || '#fff'} 80%` 
      : `${props.lightGradientStart || '#333'} 20%, ${props.gradientMid || '#666'} 50%, ${props.lightGradientEnd || '#333'} 80%`}
  );
...
// 3D Model Frame - Dark/Light mode için güncellendi
...
// Model Display Card - Dark/Light mode için güncellendi
const ModelCard = styled.div`
  width: 100%;
  height: 100%;
  position: absolute;
  background: ${props => props.isDarkMode 
    ? props.gradient || 'linear-gradient(135deg, rgba(255,255,255,0.05), rgba(255,255,255,0.01))' 
    : props.lightGradient || 'linear-gradient(135deg, rgba(0,0,0,0.05), rgba(0,0,0,0.01))'};
  border-radius: 20px;
  ...
  &::before {
    ...
    bottom: 0;
    background: ${props => props.isDarkMode 
      ? props.shine || 'linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,255,0))' 
      : props.lightShine || 'linear-gradient(135deg, rgba(0,0,0,0.05), rgba(0,0,0,0))'};
    z-index: 2;
    opacity: 0.5;
  }
...
const BackgroundGlow = styled.div`
  ...
  border-radius: 50%;
  background: ${props => props.isDarkMode 
    ? `radial-gradient(circle, ${props.color || 'rgba(255, 255, 255, 0.1)'}, transparent 70%)` 
    : `radial-gradient(circle, ${props.lightColor || 'rgba(0, 0, 0, 0.03)'}, transparent 70%)`};
    ...
    <div style={{ 
      ...
      <img 
        ...
        style={{ 
          ...
          maxHeight: '80%',
          objectFit: 'contain',
          filter: `drop-shadow(0 0 20px ${accentColor}${isDarkMode ? '66' : '40'})`
        }}
      />
    </div>
  );
...
const CustomPremiumSections = ({ onComplete }) => {
  ...
  const sections = [
    {
      ...
      description: 'Vizepedia, size ücretsiz bir hizmet sunarak, vize başvuru sürecindeki danışmanlık giderlerinden tasarruf etmenize yardımcı olur ve seyahat bütçenizi optimize eder.',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-savings.png?t=2024-10-01T13%3A58%3A51.889Z',
      bgColor: '#090909',
      accent: '#6366F1',
    ...
    },
    {
      ...
      description: 'Vizepedia, vize başvuru sürecine ilişkin bilgilere kolay ve hızlı bir şekilde erişimenizi sağlayarak, süreç yönetimini daha verimli hale getirir. Böylece, süreci daha rahat ve keyifli bir deneyime dönüştürebilirsiniz.',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-watch.png?t=2024-10-01T13%3A59%3A14.116Z',
      bgColor: '#090909',
      accent: '#10B981',
    ...
    },
    {
      ...
      description: 'Vizepedia, kullanıcıların ihtiyaçlarına göre tasarlanmış kullanıcı dostu bir arayüz sunarak, vize başvuru süreci boyunca rahat ve sorunsuz bir deneyim yaşamanıza yardımcı olur.',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-happy.png?t=2024-10-01T13%3A59%3A27.902Z',
      bgColor: '#090909',
      accent: '#EC4899',
      textPositioning: 'right',
    },
    {
      ...
      description: 'Vizepedia, vize başvuru süreçlerindeki değişiklikleri ve güncellemeleri yakından takip ederek, size her zaman en güncel ve doğru bilgileri sunar. Bu sayede, güncel bilgilere güvenerek başvurularınızı gerçekleştirin.',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-phone.png?t=2024-10-01T14%3A00%3A19.108Z',
      bgColor: '#090909',
      accent: '#3B82F6',
      textPositioning: 'left',
    },
    {
      ...
      description: 'Vizepedia, seyahat planlarınıza özel olarak hazırlanmış belge listeleriyle, vize başvuru sürecinizi profesyonel ve sistematik bir şekilde yönetmenize imkan tanır.',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-doc.png?t=2024-10-01T14%3A00%3A36.059Z',
      bgColor: '#090909',
      accent: '#F59E0B',
      textPositioning: 'right',
    },
    {
      ...
      description: 'Vizepedia, vize başvuru sürecinde her adımda size rehberlik eder ve sürecinizi kolayca takip etmenize imkan tanır. Kontrol hep sizde!',
      image: 'https://ibygzkntdaljyduuhivj.supabase.co/storage/v1/object/public/bucketto/bonbon-flight.png?t=2024-10-01T14%3A00%3A47.915Z',
      bgColor: '#090909',
      accent: '#8B5CF6',
      textPositioning: 'left',
    }
  ...
  useEffect(() => {
    ...
    const containerObserver = new IntersectionObserver(handleContainerVisibility, options);
      ...
      >
        <SectionsContainer>
          {sections.map((section, index) => {
            ...
            const addRef = (el) => { sectionsRef.current[index] = el; };
            ...
            return (
              ...
              >
                ...
                >
                  <IconWrapper 
                    color={isDarkMode ? section.accent : lightColors.accent}
                    glow={isDarkMode ? `${section.accent}80` : `${lightColors.accent}40`}
                    isDarkMode={isDarkMode}
                  >
                ...
                {/* 3D Model Display */}
                <ThreeDFrame 
                  position={section.textPositioning === 'left' ? 'right' : 'left'}
                  translateY={translateY}
                  visible={opacity > 0}
                  transform={index === currentSectionIndex ? `rotateY(${section.textPositioning === 'left' ? '15deg' : '-15deg'})` : ''}
                  isMobile={isMobile}
                >
                  <ModelFrame>
                    <ModelCard 
                    ...
                    >
                      <ModelDisplay 
                        image={section.image} 
                        accentColor={isDarkMode ? section.accent : lightColors.accent}
                        isDarkMode={isDarkMode}
                      />
                    </ModelCard>
                  </ModelFrame>
